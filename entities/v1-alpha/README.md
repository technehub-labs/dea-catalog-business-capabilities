...
This directory holds the canonical first-order Business Capability entries: 26 capabilities (23 admitted 2026-09-01 via the method lifecycle, METHODOLOGY.md section 12 gates, recommendation set from admission-gate-closeout v0.1, review record admission-review v0.1; plus Continuity Management, Idea Management and Analytics and Intelligence (the first two admitted as Resilience Management and Innovation Management, renamed at CR-DEA-BC-09) admitted via supplementary admission review v0.2 after the corpus patch and the CAND-018 boundary decision).
