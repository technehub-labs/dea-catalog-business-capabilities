# CR-DEA-BC-01A: Capability classification reconciliation: ADR-015 alignment

| Field | Value |
|-------|-------|
| **CR** | CR-DEA-BC-01A (renumbered from CR-DEA-BC-02, 2026-08-31: number yielded to the evidence-investigation CR) |
