...
**Catalog populated.** 26 canonical first-order capabilities in [`entities/v1-alpha/`](entities/v1-alpha/), admitted 2026-09-01 through the full method lifecycle (CR-DEA-BC-01 method, CR-DEA-BC-02 evidence line, CR-DEA-BC-03 schema + CI, section 12 review gates). 23 admitted 2026-09-01 via the v0.1 evidence cycle; 24/25/26 (Continuity Management, Idea Management, Analytics and Intelligence; admitted as Resilience Management and Innovation Management, renamed at CR-DEA-BC-09) admitted 2026-09-02 via supplementary admission reviews after the corpus patch and the CAND-018 boundary decision. The First-Order Business Capability Catalog Method is accepted via **CR-DEA-BC-01** ([`change-requests/CR-DEA-BC-01.md`](change-requests/CR-DEA-BC-01.md)) and normative in the method documents: [`METHODOLOGY.md`](METHODOLOGY.md) (semantics, admission, lifecycle, review), [`EVIDENCE.md`](EVIDENCE.md) (evidence methodology, source stances, provenance), [`GOVERNANCE.md`](GOVERNANCE.md) (change control, roles), [`TAXONOMY.md`](TAXONOMY.md) (structure, naming, alias policy). Canonical capability entries follow the evidence ladder and review gates defined there.
