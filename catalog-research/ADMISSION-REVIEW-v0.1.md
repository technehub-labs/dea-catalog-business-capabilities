...
| R-004 | CAND-019 Technology Management | Superseded by N-006R (CR-DEA-BC-08) | N-006's held-unmapped rationale was incorrect against the framework's canonical grounding; technology is an estate, not an enabler of execution. Now mapped at `strategy-direction × build`, parallel to Asset Management. |
